    ...
    <div className="text-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="text-3xl font-medium uppercase text-left">Прием меди</h1>
        </div>
      </section>
            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-8">
              ...
              <div className="bg-[#1f2937] p-4 text-center text-[#d3d0ce]">
                ...
                <ul className="divide-y divide-white/80">
                  <li>
                    <Link to="/cvetnoy-lom/med" className="block py-2 text-orange-500 font-bold underline">медь</Link>
                  </li>
                  <li>
                    <Link to="/cvetnoy-lom/alyuminiy" className="block py-2 text-orange-500 hover:underline">алюминий</Link>
                  </li>
                  <li>
                ...
                <p className="text-center italic mb-6 ">Цены на медь постоянно меняются, уточняйте по телефону!</p>
                ...
                <div className="text-sm text-white space-y-4 pt-20">
                    <p><strong>Прием меди в Симферополе (Республика Крым) проводит скупка-приемка <Link to="/" className="text-orange-500 underline">"В-Лом"</Link></strong> от жителей, предприятий и организаций города. Медный металлолом в чистом виде либо в сплаве можно сдать по цене, которая на порядок выше, чем у других компаний. Мы принимаем: кабель, блеск, стружку, трубы, катушки электродвигателей из меди. Ценный металл на приеме лома относят
                     к востребованному цветмету, после переработки он широко используется в промышленности. Компания предлагает высокие цены за 1 кг меди, о расценках на прием медного металлолома можно узнать из прайс-таблицы в разделе
                     <Link to="/" className="text-orange-500 underline">"Цены"</Link>
                     </p>
                </div>
                ...
                <div className="bg-[#1f2937] py-8 px-4">
                  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex flex-col gap-6 text-white w-full md:w-1/2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-sm text-white">медь от 1 кг</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/2">
                      <img src="https://metall-priem-simferopol.ru/wp-content/themes/Metall-theme/assets/slides/med-1.webp" alt="Медь" className="w-full h-auto object-cover" />
                    </div>
                  </div>
                </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto p-6 ">
            ...
            <div className="space-y-4 text-gray-800 text-sm sm:text-base leading-relaxed">
              <p>
                ...
                Заявку легко подать оператору по телефону <a href="tel:+79781606136" className="text-orange-500 font-semibold hover:underline">+7 (978) 160-61-36</a>.
