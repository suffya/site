                ...
                <div className="max-w-[1280px] mx-auto p-6 ">
                    <div className="space-y-4 text-gray-800 text-sm sm:text-base leading-relaxed text-left">
                        <p className="text-sm">
                            ...
                            <strong>Уточнить цену и условия приема металлолома легко у оператора по телефонному номеру:</strong><Link to="/cvetnoy-lom/" className="text-orange-500 hover:underline"> +7 (978) 234-94-01.</Link> Важно! Опубликованная на сайте информация не относится к договору публичной оферты.
                        </p>
